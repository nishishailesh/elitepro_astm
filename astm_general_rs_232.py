...
try:
  ...
  print("Generally installed with all python installation. Refere to python documentation. continuing without logging")
...
try:
  ...
  exception_return = sys.exc_info()
  print(exception_return)  
  print("{} can not be created. Folder donot exist? No permission? Continuing without logging".format(logfile_name))
